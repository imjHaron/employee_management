...
('kh007', 'Nguyễn Tấn Triển', 0, '123 Lương Sơn', '8754123', 'TQThong@hcmuns.edu.vn'),
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL,
  `taikhoan` varchar(31) NOT NULL,
  `matkhau` varchar(31) NOT NULL,
...
INSERT INTO `user` (`id`, `taikhoan`, `matkhau`, `uname`, `email`) VALUES
(1, 'jharon', '123', 'jHaron', 'nguyenkun2312@gmail.com'),
(2, 'pine', '123', 'Pile ga', 'chemgiosaoquan@gmail.com'),
(3, 'tien', '123', 'Tien', 'dinhlenhattien@gmail.com'),
(4, 'an', '123', 'An ngu', 'ankongu@gmail.com'),
(7, 'bep', '123', 'Bẹp béo', 'bep@gmail.com');
