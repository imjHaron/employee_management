        ...
        if (isset($_POST['tinh'])) {
            if (is_numeric($a) && is_numeric($b)) {
                ...
                case 1:
                    ...
                    echo "<br>Diện tích hình vuông: $dien_tich";
                    break;
                case 2:
                    $chu_vi = 2 * M_PI * $b;
                    $dien_tich = M_PI * $b * $b;
                    echo "Chu vi hình tròn: $chu_vi";
                    echo "<br>Diện tích hình tròn: $dien_tich";
                    break;
                case 3:
                    $chu_vi = 3 * $b;
                    $dien_tich = sqrt(3) * $b * $b / 4;
                    echo "Chu vi hình tam giác đều: $chu_vi";
                    echo "<br>Diện tích hình tam giác đều: $dien_tich";
                    break;
                case 4:
                    $chu_vi = 2 * ($a + $b);
                    $dien_tich = $a * $b;
                    echo "Chu vi hình chữ nhật: $chu_vi";
                    echo "<br>Diện tích hình chữ nhật: $dien_tich";
                    break;
                default:
